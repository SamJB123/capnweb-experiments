 ...
 * is never reported back. Both peers must understand `["oneway"]` (this fork, 0.12.0-hibernation.1 /
 * 0.12.0-hibernation-cbor.1 or later); through a resolved or local hook it degrades to call + dispose.
 */
